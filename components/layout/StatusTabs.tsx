...
const STATUSES: TicketStatus[] = ["NEW", "OPEN", "DONE", "CANCELLED"];
          ...
          {STATUSES.map((s) => {
            ...
            return (
              <button
                ...
                className={clsx(
                  "relative px-2 sm:px-3 md:px-4 lg:px-6 py-3 sm:py-3 md:py-4 text-xs sm:text-sm md:text-base lg:text-lg font-bold transition-all duration-300",
              ...
              >
                <span className="inline-flex items-center gap-1 sm:gap-1.5 md:gap-2">
                  ...
                  {s === "CANCELLED" && <CancelIcon sx={{ fontSize: { xs: 14, sm: 16, md: 18, lg: 20 } }} />}
