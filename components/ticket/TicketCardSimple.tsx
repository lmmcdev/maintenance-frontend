...
export function TicketCard({ t, apiBase, onChanged }: TicketCardProps) {
  ...
  return (
    <article
      className="rounded-xl sm:rounded-2xl border border-gray-200/60 bg-white p-3 sm:p-4 md:p-6 lg:p-8 shadow-lg sm:shadow-2xl transition-all duration-300 hover:scale-[1.01] sm:hover:scale-[1.02] backdrop-blur-sm relative"
      style={{
        boxShadow:
          "0px 4px 16px rgba(239, 241, 246, 0.8), 0px 8px 24px rgba(239, 241, 246, 1)",
        zIndex: isAssignDropdownOpen || isCategoryDropdownOpen ? 10 : "auto",
      }}
    >
      {/* Header */}
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          {(t.audio?.url || t.audioUrl) && (
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <h4 className="font-bold text-[#00a1ff] text-xs sm:text-sm">
                {translate("audio")}
              </h4>
            </div>
          )}
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <span className="text-xs text-gray-500 font-medium">{translate("created")}: </span>
      ...
      <div className="mb-4 sm:mb-5">
        <div
          className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-2 sm:p-3 md:p-4 space-y-3 sm:space-y-4"
          style={{
            boxShadow:
              "0px 4px 16px rgba(239, 241, 246, 0.8), 0px 8px 24px rgba(239, 241, 246, 1)",
          }}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
              ...
              <div className="flex-1 relative">
                ...
                {isAssignDropdownOpen && !busy && (
                  <div
                    className="absolute z-[9999] w-full mt-1 bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-2xl max-h-64 overflow-hidden"
                    style={{
                      boxShadow:
